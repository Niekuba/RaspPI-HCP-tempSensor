...
public class Temperature {
    ...
    public static String SERVLET_URL_cloud = "https://temperaturap1941827957trial.hanatrial.ondemand.com/iotscenario/";
    ...
    public static String SENSOR_HARDWARE_ID = "28-0000059eb789";
    ...
    public static String SENSOR_DB_ID_TEMP_SENSOR = "2101";
    ...
    public static void main(String args[]) {
        ...
        for (int i = 0; i < repeats; i++) {
            ...
            String infoSensor2 = getSensorInfo(SENSOR_DB_ID_TEMP_SENSOR, "Celsius", "1", "0");
            if (infoSensor2 != null) {
    ...
    private static String getSensorInfo(String sensorId, String valueUnit, String sensorValueMultiplier, String sensorValueCalibration) {
        ...
        String sensorValueFloat = null;

        if (fileContent != null && fileContent.length() > 0) {
            String[] temp = fileContent.split("t=");
            sensorValueFloat = temp[1].trim();
            float sensorValueTemp=Float.parseFloat(sensorValueFloat);
            String sensorValue=Float.toString(sensorValueTemp/1000);
